...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void txtPasswordKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPasswordKeyPressed
        ...
        {
            if(txtPassword.getText().equals("sanmarcos"))
            {
                if(CONFIG_FORMS.frmMain == null)
                {
            ...
            {
                JOptionPane.showMessageDialog(this, "La clave ingresada es inválida", "Error de ingreso", JOptionPane.ERROR_MESSAGE);
                txtPassword.setText("");
            }
        }
